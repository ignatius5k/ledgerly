...
test("guest entry, invoice editor, responsive layout, draft, print, and offline shell", async (context) => {
  ...
  assert.deepEqual(guestState, {
    ...
    brandName: "Ledgerly",
    headerLogo: "./ledgerly-mark.png?v=64",
    invoiceLogo: "./eng-hoon-residences-logo.png?v=64",
